...
import { useCreateUserBanking } from '../../refund/hooks/useBanking.hook'
...
const AddUserBankingScreen = () => {
    const navigation = useNavigation<ProfileStackNavigationProp>()
    const { mutate: createBanking, isPending } = useCreateUserBanking()
    ...
    return (
        <View style={styles.container}>
            <PrimaryHeader title="Thêm ngân hàng" onBackPress={handleGoBack} />
            ...
            <View style={styles.bottomContainer}>
                ...
                >
                    {isPending ? (
                        ...
                        <Text style={styles.submitButtonText}>Thêm ngân hàng</Text>
                    )}
                </TouchableOpacity>
            </View>
...
export default AddUserBankingScreen
