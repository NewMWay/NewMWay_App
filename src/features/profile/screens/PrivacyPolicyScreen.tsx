...
import { PRIVACY_POLICY, POLICY_UPDATE_DATE, POLICY_WEB_URL } from '../../../constants/policyData'
...
const arrowIcon = require('../../../assets/icons/icons8-forward-48.png')
    ...
    if (showWebView) {
        return (
            <View style={styles.container}>
                <PrimaryHeader title="Chi Tiết Chính Sách" onBackPress={() => setShowWebView(false)} />
                <WebView
    ...
    return (
        <View style={styles.container}>
            <PrimaryHeader title="Chính Sách Bảo Mật" onBackPress={() => navigation.goBack()} />
            ...
            <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
                <View style={styles.content}>
                    ...
                    <View style={styles.noteCard}>
                        <Image source={shiledIcon} style={{width: ifTablet(24, 22), height: ifTablet(24, 22), tintColor: Colors.textWhite}} />
                        <Text style={styles.noteText}>
                            Chúng tôi cam kết bảo vệ thông tin cá nhân của bạn một cách an toàn.
                        </Text>
                    </View>
                </View>
            </ScrollView>
